...
- **enrich**: s_baseline, s_annot, v_annot, model, params, fix, std.lv, toler, fixparam
...
### Enrichment options
- `enrich(rm_flank)` — Flanking region removal is not yet implemented.
- `enrich(tau)` — Tau parameterization is not yet implemented.
